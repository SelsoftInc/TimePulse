      ...
      <div className="auth-container">
        <div className="auth-card">
          ...
          <div className="auth-footer">
            ...
            <Link to="/simple-login" className="btn btn-primary mt-3">Back to Login</Link>
          </div>
        </div>
      </div>
    );
  ...
  return (
    <div className="auth-container">
      <div className="auth-card">
        ...
        <div className="auth-footer">
          <p>Already have an account? <Link to="/simple-login" className="auth-link">Sign In</Link></p>
        </div>
      </div>
    </div>
  );
