                        ...
                        <div className="card-inner p-0 border-top">
                          <div className="nk-tb-list nk-tb-ulist">
                            ...
                            <div className="nk-tb-item">
                              ...
                              <div className="nk-tb-col">
                                <Link href="#pending" className="btn btn-dim btn-sm btn-outline-primary">View All</Link>
                              </div>
                            </div>
                            <div className="nk-tb-item">
                              <div className="nk-tb-col">
                              ...
                              <div className="nk-tb-col">
                                <Link href="#flagged" className="btn btn-dim btn-sm btn-outline-primary">View All</Link>
                              </div>
                            </div>
                            <div className="nk-tb-item">
                              <div className="nk-tb-col">
                              ...
                              <div className="nk-tb-col">
                                <Link href="#approved" className="btn btn-dim btn-sm btn-outline-primary">View All</Link>
                              </div>
                            </div>
                          </div>
                        </div>
