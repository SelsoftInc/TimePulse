...
if (fs.existsSync(serverEnvPath)) {
  ...
  if (serverEnv.includes('ENCRYPTION_KEY=')) {
    ...
    console.log('✅ Updated ENCRYPTION_KEY in server/.env');
  } else {
    // Add new key
    serverEnv += `\n# Encryption Key for API Responses\nENCRYPTION_KEY=${ENCRYPTION_KEY}\n`;
    console.log('✅ Added ENCRYPTION_KEY to server/.env');
  }
  ...
  if (fs.existsSync(templatePath)) {
    ...
    console.log('✅ Created server/.env with encryption key');
  }
}
