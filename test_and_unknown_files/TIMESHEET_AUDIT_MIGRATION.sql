...
-- 
-- Usage: Copy and paste this entire script into AWS RDS Query Editor
-- =============================================
...
SELECT 
    table_name,
    (SELECT count(*) FROM information_schema.columns WHERE table_name = 'timesheet_audit') as column_count
